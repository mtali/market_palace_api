...
RSpec.describe OrderMailer, type: :mailer do
  ...
  describe ".send_confirmation" do
    ...
    it "should be set to be delivered o the user from the order passed in" do
    ...
    it "should contain the user's message in that mail body" do
    ...
    it "should have products count" do
